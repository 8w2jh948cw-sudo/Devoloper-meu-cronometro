...
async function init(){
  ...
  if(!window.__CRONOMETRO_ARCHIVE__&&'serviceWorker' in navigator){try{await navigator.serviceWorker.register('./sw.js');}catch(e){console.warn('Service worker não registrado',e);}}
